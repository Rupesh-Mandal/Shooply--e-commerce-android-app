...
import static com.firoz.shooply.util.Constant.updateProduct;
...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String user=sharedpreferences.getString("authUser","");
        authUserForSeller=new Gson().fromJson(user, new TypeToken<AuthUser>() {}.getType());
