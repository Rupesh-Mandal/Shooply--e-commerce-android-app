...
public class OrderHistoryAdapter extends RecyclerView.Adapter<OrderHistoryAdapter.myViewHolder>{
    ...
    public OrderHistoryAdapter(Context context, ArrayList<OrderModel> orderModelArrayList) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new myViewHolder(LayoutInflater.from(context).inflate(R.layout.history_order_item,null,false));
