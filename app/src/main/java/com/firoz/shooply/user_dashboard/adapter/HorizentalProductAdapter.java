...
public class HorizentalProductAdapter extends RecyclerView.Adapter<HorizentalProductAdapter.myViewHolder> {
    Context context;
    ArrayList<Product> productArrayList;
    UserProductOnClick userProductOnClick;

    public HorizentalProductAdapter(Context context, ArrayList<Product> productArrayList, UserProductOnClick userProductOnClick) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.horizental_product_item, null, false);
